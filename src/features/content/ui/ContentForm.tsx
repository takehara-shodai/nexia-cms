...
const statusOptions: { value: ContentStatus; label: string; color: string }[] = [
  {
    value: 'draft' as ContentStatus,
    label: '下書き',
    color: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
  },
  {
    value: 'review' as ContentStatus,
    label: 'レビュー中',
    color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400',
  },
  {
    value: 'published' as ContentStatus,
    label: '公開',
    color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
  },
  {
    value: 'archived' as ContentStatus,
    label: 'アーカイブ',
    color: 'bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400',
  },
];

export const ContentForm = forwardRef(function ContentForm(
  { content = null, isPreview = false, onSuccess }: ContentFormProps,
  ref
) {
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
              ...
              <Select
                ...
                onValueChange={value => {
                  ...
                  handleChange(
                    'status_id',
                    statusIdMap[value as ContentStatus] || 'f0a6c4b0-7c91-4d1a-9e3a-a3dd76c46fdb'
                  );

                  console.log(
                    `Status changed to: ${value}, status_id: ${statusIdMap[value as ContentStatus]}`
                  );
                }}
              >
